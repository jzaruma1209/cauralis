...
export default function EcommercePage() {
  ...
  const visibles =
    filtro === "Todas" ? demosEcommerce : demosEcommerce.filter((d) => d.categoria === filtro);
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="mb-16 relative">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-slate-100 leading-tight">
              Ecommerce que <span className="hero-gradient-text">Vende Solo</span>
            </h1>
            <p className="text-xl text-slate-400 leading-relaxed max-w-3xl mb-10">
              Tiendas en línea robustas y escalables con pasarelas de pago integradas
              y una experiencia de compra diseñada para maximizar conversiones.
            </p>
              ...
              >
                ...
                {cat !== "Todas" && (
                  <span className="ml-2 text-xs opacity-60">
                    ({demosEcommerce.filter((d) => d.categoria === cat).length})
                  </span>
                )}
              </button>
            ))}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 p-10 rounded-[2rem] bg-gradient-to-br from-slate-900 via-accent-blue/40 to-slate-900 border border-slate-800 relative overflow-hidden">
            ...
            <div>
              ...
              <div className="text-5xl font-bold text-slate-100">
                $799<span className="text-xl text-slate-500 font-normal ml-2">USD</span>
              </div>
              <p className="text-slate-400 text-sm mt-2 max-w-sm">
                Diseño, desarrollo, pasarela de pago, panel admin y capacitación incluidos.
              </p>
            </div>
